...
vpath %.c src src/asm src/bigint src/bitset src/collection src/collection/abstract src/collection/hashmap src/collection/hashset src/collection/list src/collection/sequence src/collection/tree src/collection/vector src/core src/core/ft_printf src/hash src/slab 
