...
vpath %.c src src/bigint src/bitset src/core src/core/ft_printf src/collection src/collection/hashset src/collection/tree src/collection/hashmap src/collection/vector src/collection/list src/collection/abstractobj src/collection/abstractseq src/slab src/asm src/hash src/util src/task 
