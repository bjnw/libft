...
vpath %.c src src/bigint src/bitset src/core src/collection src/collection/sequence src/collection/hashset src/collection/tree src/collection/hashmap src/collection/vector src/collection/list src/collection/abstract src/slab src/asm src/hash src/util
